...
const listDisease = () => models.disease.findAll({ where: { isDeleted: false }, order: [['id', 'ASC']] });
...
const deleteDisease = async (id) => { await models.disease.update({ isdeleted: true }, { where: { id } }); };
