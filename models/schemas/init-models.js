...
function initModels(sequelize) {
    ...
    checkup.belongsToMany(disease, { as: 'iddisease_diseases', through: checkupDisease, foreignKey: 'idcheckup', otherKey: 'iddisease' });
    checkup.belongsToMany(medicine, { as: 'medicine_medicines', through: checkupMedicine, foreignKey: 'checkup', otherKey: 'medicine' });
    disease.belongsToMany(checkup, { as: 'idcheckup_checkups', through: checkupDisease, foreignKey: 'iddisease', otherKey: 'idcheckup' });
    medicine.belongsToMany(checkup, { as: 'checkup_checkups', through: checkupMedicine, foreignKey: 'medicine', otherKey: 'checkup' });
    ...
    checkup.hasMany(checkupDisease, { as: 'checkup-diseases', foreignKey: 'idcheckup' });
    checkupMedicine.belongsTo(checkup, { as: 'checkup_checkup', foreignKey: 'checkup' });
    checkup.hasMany(checkupMedicine, { as: 'checkup-medicines', foreignKey: 'checkup' });
    checkupDisease.belongsTo(disease, { as: 'iddisease_disease', foreignKey: 'iddisease' });
    disease.hasMany(checkupDisease, { as: 'checkup-diseases', foreignKey: 'iddisease' });
    checkupMedicine.belongsTo(medicine, { as: 'medicine_medicine', foreignKey: 'medicine' });
    medicine.hasMany(checkupMedicine, { as: 'checkup-medicines', foreignKey: 'medicine' });
